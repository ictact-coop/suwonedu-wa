<?php
    /**
     * @class jdh_newest_category
     * @author zero (zero@nzeo.com)
	 * @designed by jobdahan.net (ceo@wizone.co.kr)
     * @brief 최근 게시물을 출력하는 위젯
     * @version 0.1
     **/

    class jdh_newest_category extends WidgetHandler {
        ...
        function proc($args) {
            ...
            // jdh_newest_category 위젯에서 정의한 query문을 직접 사용
            $obj->sort_index = 'documents.'.$order_target;
            $obj->order_type = $order_type=="desc"?"asc":"desc";
            $obj->list_count = $list_count;
			$obj->category_srl = $args->category_srl;   
            $output = executeQueryArray('widgets.jdh_newest_category.getNewestDocuments', $obj);
