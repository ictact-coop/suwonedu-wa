    ...
    this.show = function() {
        ...
        if (this.width) {
            ...
            if (this.position == 'center') {
				...
				jQuery(target_selector).css('top', '3.4%');
                jQuery(target_selector).css('margin-left', Math.round(this.width / 2) * -1.0);
			    jQuery(target_selector).css('margin-top', Math.round(this.height / 2) * 5.1);
            }
